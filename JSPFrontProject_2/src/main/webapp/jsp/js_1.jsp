	...
	4. JavaScript : 브라우저에서 사용자 요청 처리 담당
		...
		브라우저 ================== 자바 =================== 오라클
		  => 자바스크립트			 ----
				...
				--------------------
						...
						~VO ===> {} Object => ***JSON
									자바스크립트 객체 표현법
						List ==> [] Array
		  => 브라우저안에서 자바에서 전송을 받아서 동적으로 화면 출력
						--------------------
		  => 동적
			 언어
			 	소스코드 == 컴파일러 == 기계어 출력 == 출력
		  ...
		  => 버전
			 ...
			 자바스크립트 출력 : Java의 System.out.println()와 같은 역할
			 ------------ 브라우저에 출력
			 1) alert() : 팝업창
			 2) console.log() => 도스 출력
			 3) document.write() => 브라우저 출력
			 4) innerHTTML : 태그와 태그 사이에 데이터 출력
			 	=> Ajax / React / Vue
		  	...
		  	1) 변수 선언
		  		...
		  		=> 자바 : main()
		  		   자바스크립트 : window.onload=function(){}
		  				Squery : $(function(){})
		  				react : componentDidMount() => useEffec()
		  				vue : mounted()
		  				-----------------------------------------                                                            
--%>
<!DOCTYPE html>
