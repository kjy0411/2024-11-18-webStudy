...
public class MainServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<a href=MusicList2 class=\"btn btn-lg btn-warning\">음악</a>");
		out.println("<a href=FoodFindList class=\"btn btn-lg btn-danger\">맛집검색</a>");
		out.println("<a href=MusicFindList class=\"btn btn-lg btn-primary\">음악검색</a>");
		out.println("</div>");
		out.println("</div>");
		out.println("</body>");
		out.println("</html>");
