...
<body>
	<div class="container">
		...
		<div class="row text-center" style="margin-top: 20px">
			...
			<input type="button" value="중식" class="btn-sm btn-info">
			<input type="button" value="일식" class="btn-sm btn-success">
			<input type="button" value="양식" class="btn-sm btn-warning">
