	...
	<form method="post" action="../admin/notice_update_ok.do">
		<table class="table">
			...
			<tr>
				...
				<td width="85%">
					<input type="text" name="subject" id="subject" size="50" class="input-sm" required value="${vo.subject }">
			...
			<tr>
				<td colspan="2" class="text-center">
					<input type="submit" value="수정" class="btn-primary btn-sm btn">
					<input type="button" value="취소" class="btn-danger btn-sm btn" onclick="javascript:history.back()">
				</td>
			</tr>
		</table>
	</form>
