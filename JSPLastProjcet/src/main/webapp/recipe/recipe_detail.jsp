            				...
            				<c:forEach var="make" items="${mList }" varStatus="s">
            					<table class="table">
            						<tr>
            							<td width="80%">${make }</td>
            							<td width="20%">
            								<img src="${iList[s.index]}" style="width: 250px;">
            							</td>
            						</tr>
            					</table>
            				</c:forEach>
            	...
            	<table class="table">
            		...
            		<tr>
            			<td width=20% class="text-center" rowspan="2">
            				<img src="${vo.chef_poster }" width="100px" height="100px" class="round-circle">
            			</td>
            			<td width=80%>
            				<h3>${vo.chef }</h3>
            			</td>
												...
												<div class="comment-content">
													...
													<c:if test="${sessionScope.id!=null }">
														...
														<c:if test="${sessionScope.id==rvo.id }">
															...
															<a class="active" href="../reply/reply_delete.do?cno=${rvo.cno }&rno=${rvo.rno}&type=2">삭제</a>
														</c:if>
													</c:if>
