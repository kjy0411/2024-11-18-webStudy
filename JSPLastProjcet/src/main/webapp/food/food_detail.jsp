					...
					<div class="row no-gutters">
						...
						<div class="col-12 col-sm-12">
								...
								<tr>
									<td class="text-right">
										<c:if test="${sessionScope.id!=null }">
											...
											<c:if test="${jCount==0}">
												<a href="../jjim/jjim_insert.do?rno=${vo.fno }&type=1" class="btn btn-sm btn-outline-info">찜하기</a>
											</c:if>
											<c:if test="${jCount!=0}">
										...
										<a href="../food/food_list.do" class="btn btn-sm btn-primary">목록</a>
									</td>
								</tr>
							</table>
							<%-- 지도 위치 --%>
							        ...
							        <div class="option">
							            <div>
							                <form onsubmit="searchPlaces(); return false;">
							                    키워드 : <input type="text" value="${addr } 맛집" id="keyword" size="15" readonly="readonly"> 
							                </form>
							            </div>
							        </div>
							        <hr>
							...
							<div class="comment_area section_padding_50 clearfix">
								<h4 class="mb-30">댓글(${vo.replycount })</h4>
												...
												<div class="comment-content">
													...
													<c:if test="${sessionScope.id!=null }">
														...
														<c:if test="${sessionScope.id==rvo.id }">
															...
															<a class="active" href="../reply/reply_delete.do?cno=${rvo.cno }&rno=${rvo.rno}&type=1">삭제</a>
														</c:if>
													</c:if>
													<div class="comment-form ups" style="display: none;" id="up${rvo.cno }">
														...
														<form action="../reply/reply_update.do" method="post">
															<div class="form-group">
																...
																<button type="submit" class="btn btn-primary" style="width: 100px;height: 75px;float: left">댓글수정</button>
															</div>
														</form>
													</div>
												</div>
								...
								<div class="leave-comment-area section_padding_50 clearfix">
									<div class="comment-form">
										...
										<form action="../reply/reply_insert.do" method="post">
											<div class="form-group">
												<textarea  name="msg" id="msg" cols="76" rows="4" placeholder="Message" style="float: left;" required></textarea>
												<input type="hidden" name="type" value="1">
												<input type="hidden" name="rno" value="${vo.fno }">
