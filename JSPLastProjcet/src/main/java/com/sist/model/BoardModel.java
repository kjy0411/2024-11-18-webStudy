...
public class BoardModel {
	...
	public String board_inset(HttpServletRequest request, HttpServletResponse response) {
		
		request.setAttribute("main_jsp", "../board/board_insert.jsp");
		return "../main/main.jsp";
	}
	@RequestMapping("board/board_insert_ok.do")
	public String board_inset_ok(HttpServletRequest request, HttpServletResponse response) {
	...
	public String board_update_ok(HttpServletRequest request, HttpServletResponse response) {
		...
		String db_pwd=BoardDAO.boardGetPassword(vo.getNo());
		...
		//return "redirect:../board/board_detail.do?no="+no+"&page="+page;
	}
}
