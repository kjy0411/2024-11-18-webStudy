...
public class ReplyDAO {
	// 연결 => 오라클 
	  ...
	  public void foodReplyInsert(ReplyVO vo)
	  {
		  ...
		  {
			  getConnection();
			  String sql="INSERT INTO reply(rno, fno, id, name, msg, regdate) VALUES("
	  ...
	  public void musicReplyInsert(ReplyVO vo)
	  {
		  try
		  {
			  getConnection();
			  String sql="INSERT INTO reply(rno, mno, id, name, msg, regdate) VALUES("
					  +"reply_rno_seq.nextval,?,?,?,?,SYSDATE)";
			  ps=conn.prepareStatement(sql);
	  ...
	  public List<ReplyVO> foodReplyListData(int fno)
	  {
		  List<ReplyVO> list=
	  ...
	  public List<ReplyVO> musicReplyListData(int mno)
	  {
		  List<ReplyVO> list=
				  new ArrayList<ReplyVO>();
		  try
